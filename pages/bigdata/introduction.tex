...
%
\begin{enumerate}
	\item By default, MRJob splits the input (the \texttt{en_perline001.txt} file) by lines. This means that each line may be sent to a different worker. We have taken care of this detail for you, but when you use MRJob for your own projects, remember that the input is split by lines unless you configure it differently.
...
\begin{verbatim}
python wordcount.py -r emr en_perline001.txt
\end{verbatim}
