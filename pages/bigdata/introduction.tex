...
\begin{verbatim}
python big_data/trimercount.py -r emr s3://lxmls-labs/en_perline01.txt > en.counts.txt

python big_data/trimercount.py -r emr s3://lxmls-labs/pt_perline10.txt > pt.counts.txt
\end{verbatim}
