...
We recommend that you make a copy of \verb+emstep.py+ and edit it, adding the code snippets we provide below.
...
Here we also made use of the word\_tag\_dict.pkl file to get the
