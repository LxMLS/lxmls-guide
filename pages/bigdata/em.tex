...
\textbf{Important:} You now need to keep track of how many sequences you saw. % FIXME Check this.
...
In order to distinguish all of these, we will emit them as a complex key:
