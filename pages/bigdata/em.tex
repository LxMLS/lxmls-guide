...
We recommend that leave the file \verb+emstep.py+ alone and experiment with the code snippets we provide below in a separate script until you get to section \ref{beginMR}.
