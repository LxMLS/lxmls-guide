...
visual explanation of the differences between simples RNNs, GRUs and LSTMS please visit http://colah.github.io/posts/2015-08-Understanding-LSTMs/

\begin{figure}[!h]
\centering
\includegraphics[scale=0.6]{figs/deep_learning/LSTM3-chain.png}
\caption{Detailed explanation of the LSTM internal logic, see source: http://colah.github.io/posts/2015-08-Understanding-LSTMs/.}
\label{fig:RNN}
\end{figure}
