...
With this in mind, we will know generalize this process. We define the probability $p(\theta|x)$, which is probability of the parameter $\theta$, given the data $x$. 
...
We can that likelihood is highest when the distribution $f$ with parameter $p$ is the best fit for the observed samples.
