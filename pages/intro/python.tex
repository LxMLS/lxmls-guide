...
\textbf{Important}: When you modify a module, you need to reload the notebook page for the changes to take effect. Autoreload is set by defect in the schools notebooks. Autoreload is set by defect in the school's notebooks.
