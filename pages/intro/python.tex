...
\todo[inline]{Mariana (suggestion): it would be useful to refer that python can be called in pdb mode. This mode stops the program  automatically in a pdb just before exiting from an error.}
