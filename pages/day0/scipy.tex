...
\todo[inline]{Mariana: the dataset was already introduced before; The next exercise (0.14) is also repeated.}
...
$\vect{w} \in R^2$). \todo[inline]{Mariana: in the first formula the problem is actually one dimensional; only the second formula is two dimensional...}
