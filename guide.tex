...
% T1 encoding is required by the python listings (upquote=true renders straight
% quotes via \textquotedbl/\textquotesingle, unavailable in the default OT1).
...
\input{pages/transformers.tex}

\chapter{Multimodal Models}
\input{pages/multimodal.tex}
...
%\input{pages/reinforcement_learning/reinforcement_learning.tex}
